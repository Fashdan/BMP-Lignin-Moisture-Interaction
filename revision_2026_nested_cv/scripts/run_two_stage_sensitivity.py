...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "## Interpretation",
        "- If the two-stage derived BMP/DM error is close to the direct BMP/DM model, the practical target can be retained while transparently explaining the VS/DM conversion.",
        "- If it is materially weaker, the direct model should remain the primary practical BMP/DM predictor, with this diagnostic used to clarify that target-normalisation coupling contributes to performance.",
        "- In both cases, the deterministic conversion must not be described as independent biochemical prediction.",
        "",
        "## Saved Artifacts",
        "- Row-level two-stage OOF predictions: `stage2_outputs/predictions/two_stage_bmpvs_to_bmpdm_oof_predictions.csv`",
        "- Row-level direct comparison: `stage2_outputs/predictions/two_stage_vs_direct_bmpdm_oof_comparison.csv`",
        "- Fold metrics: `stage2_outputs/tables/two_stage_bmpvs_to_bmpdm_fold_metrics.csv`",
        "- Summary table: `stage2_outputs/tables/two_stage_bmpvs_to_bmpdm_metrics_summary.csv`",
        "- Paired error summary: `stage2_outputs/tables/two_stage_vs_direct_bmpdm_paired_error_summary.csv`",
    ]
